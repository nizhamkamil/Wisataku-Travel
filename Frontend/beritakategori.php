...
<?php 
    ...
    $kodekonten = $_GET['kategoriberita']; 
    $detilberita = mysqli_query($con,"SELECT * FROM beritakategori,beritakonten WHERE beritakategori.beritaID = beritakonten.beritaID and beritakategori.beritaID ='$kodekonten'");
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <?php if(mysqli_num_rows($detilberita) > 0 ) {
                    while($rowberita = mysqli_fetch_array($detilberita)){
                         ?>
                ...
                <?php } } else{ ?>
                <h3 style="margin-top: 50px; text-align:center">Maaf Berita untuk kategori ini belum ada</h3>
                <?php } ?>
            </div>
            <div class="col-md-4">
