...
<?php 
    ...
    $kodekonten = $_GET['kategori']; 
    $detilberita = mysqli_query($con,"SELECT * FROM kategori,destinasi,fotodestinasi WHERE kategori.kategoriID = destinasi.kategoriID AND kategori.kategoriID = '$kodekonten' AND fotodestinasi.destinasiID = destinasi.destinasiID");
    $detilberita1 = mysqli_query($con,"SELECT kategoriNama FROM kategori WHERE kategoriID = '$kodekonten'");
?>
...
<body>
    ...
    <!-- GALLERY START -->
    <div class="container">
        <?php $rowfotodestinasi1 = mysqli_fetch_array($detilberita1) ?>
        <h1 style="text-align: center; margin-top:50px">Destinasi Wisata <?php echo $rowfotodestinasi1['kategoriNama']?>
        </h1>
        <div class="row">
            <?php while($rowfotodestinasi = mysqli_fetch_array($detilberita)){ ?>
            <? echo $rowfotodestinasi['kategoriNama'] ?>
            <div class="col-sm-4">
            ...
            <?php }?>
            <?php $queryberitakonten = mysqli_query($con,"SELECT * FROM kategori,destinasi,fotodestinasi WHERE kategori.kategoriID = destinasi.kategoriID AND kategori.kategoriID = '$kodekonten' AND fotodestinasi.destinasiID = destinasi.destinasiID");
