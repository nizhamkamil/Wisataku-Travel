...
<?php 
    ...
    $kodekonten = $_GET['area']; 
    $detilberita = mysqli_query($con,"SELECT * FROM area,destinasi,fotodestinasi WHERE area.areaID = destinasi.areaID AND area.areaID = '$kodekonten' AND fotodestinasi.destinasiID = destinasi.destinasiID");
    $detilberita1 = mysqli_query($con,"SELECT arenaNama,areaKeterangan FROM area WHERE areaID = '$kodekonten'");
?>
...
<body>
    ...
    <div class="container">
        ...
        <h1 style="text-align: center; margin-top:50px">Area Wisata <?php echo $rowfotodestinasi1['arenaNama']?>
            <p style="font-size: 20px; opacity:70%; margin-top:20px"><?php echo $rowfotodestinasi1['areaKeterangan'] ?>
            </p>
        </h1>
        <div class="row">
            <?php while($rowfotodestinasi = mysqli_fetch_array($detilberita)){ ?>
            <? echo $rowfotodestinasi['arenaNama'] ?>
            <div class="col-sm-6">
