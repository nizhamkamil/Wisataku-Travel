...
<?php 
    ...
    if(isset($_POST['simpan'])){
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "png")){
            ...
            mysqli_query($con,"INSERT INTO hotel VALUES ('$kodehotel','$namahotel','$nama','$kodeprovinsi')");
    ...
    <div class="col-sm-10">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodehotel" name="inputkode" placeholder="Kode Hotel"
                        maxlength="4">
                </div>
            </div>
