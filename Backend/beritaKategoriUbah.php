...
<?php
   ...
   mysqli_query($con,"UPDATE beritakategori SET beritaKategori='$kategorinama', beritaKeterangan='$kategoriket'
   WHERE beritaID='$kategorikode'");

    }
    
    $kodekategori = $_GET['ubah'];
    $editkategori = mysqli_query($con,"SELECT * FROM beritakategori WHERE beritaID='$kodekategori'");
...
<head>
    ...
    <title>Input Kategori Berita</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">input Kategori berita</h1>
                </div>
            </div>
            <form method="POST">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="inputkode" id="kodekategori"
                            value="<?php echo $rowedit['beritaID'] ?>" readonly maxlength="4" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="inputnama" id="namakategori"
                            value="<?php echo $rowedit['beritaKategori'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="inputket" id="keterangankategori"
                            value="<?php echo $rowedit['beritaKeterangan'] ?>">
                    </div>
                </div>
                <div class="form-group row">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Daftar Kategori Berita</h1>
            ...
            <table class="table table-hover table-danger">
                ...
                <tbody>
                    ...
                    if(isset($_POST["kirim"])){
                        ...
                        $query = mysqli_query($con,"SELECT * FROM beritakategori");
                    }
                    $nomor = 1;
                    ...
                    <tr>
                        ...
                        <td> <a href="beritaKategoriUbah.php?ubah=<?php echo $row['beritaID']?>"
                        ...
                        <td><a href="beritaKategoriHapus.php?hapus=<?php echo $row['beritaID']?>"
