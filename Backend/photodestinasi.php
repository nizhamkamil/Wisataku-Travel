...
<?php 
    ...
    if(isset($_POST['simpan'])){
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG") or ($ekstensifile == "jpeg") or ($ekstensifile == "png")){
            ...
            mysqli_query($con,"INSERT INTO fotodestinasi VALUES ('$kodefoto','$namafoto','$kodedestinasi','$nama')");
    ...
    <div class="col-sm-10">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodefoto" name="inputkode" placeholder="Kode Photo"
                        maxlength="4">
                </div>
            </div>
