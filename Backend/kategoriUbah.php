...
<?php
    ...
    mysqli_query($con,"UPDATE kategori SET  kategoriNama ='$kategorinama', kategoriKeterangan='$kategoriket', kategoriReferensi='$kategoriref'
    WHERE kategoriID='$kategorikode'");

    }
 
    $kodekategori = $_GET['ubah'];
    $editkategori = mysqli_query($con,"SELECT * FROM kategori WHERE kategoriID='$kodekategori'");
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="inputkode" id="kodekategori"
                            value="<?php echo $rowedit['kategoriID'] ?>" readonly maxlength="4" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="inputket" id="keterangankategori"
                            value="<?php echo $rowedit['kategoriKeterangan'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="inputref" id="kodereferensi"
                            value="<?php echo $rowedit['kategoriReferensi'] ?>">
                    </div>
                </div>
                <div class="form-group row">
