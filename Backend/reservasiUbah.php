...
mysqli_query($con,"UPDATE reservasi SET reservasiPemesan='$reservasinama',destinasiID='$destinasikode',hotelID='$hotelkode',agencyID='$agencykode'
            WHERE reservasiID='$resevasikode'");
...
$kodereservasi = $_GET['ubah'];
$editreservasi = mysqli_query($con,"SELECT * FROM reservasi WHERE reservasiID = '$kodereservasi'");
$rowedit = mysqli_fetch_array($editreservasi);

$editdestinasi = mysqli_query($con,"SELECT * FROM reservasi,destinasi
WHERE reservasiID ='$kodereservasi' AND reservasi.destinasiID = destinasi.destinasiID ");
$rowedit2 = mysqli_fetch_array($editdestinasi);

$edithotel = mysqli_query($con,"SELECT * FROM reservasi,hotel
WHERE reservasiID ='$kodereservasi' AND reservasi.hotelID = hotel.hotelID ");
$rowedit3 = mysqli_fetch_array($edithotel);

$editagency = mysqli_query($con,"SELECT * FROM reservasi,travelagency
WHERE reservasiID ='$kodereservasi' AND reservasi.agencyID = travelagency.agencyID ");
$rowedit4 = mysqli_fetch_array($editagency);
?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="inputkode" id="kodedestinasi"
                                value="<?php echo $rowedit['reservasiID'] ?>" readonly maxlength="4" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="inputnama" id="namadestinasi"
                                value="<?php echo $rowedit['reservasiPemesan'] ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="kodekategori" name="kodekategori">
                                <option value="<?php echo $rowedit['hotelID'] ?>"><?php echo $rowedit['hotelID'] ?>
                                    <?php echo $rowedit3['hotelNama'] ?>
                                    <div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="kodearea" name="kodearea">
                        <option value="<?php echo $rowedit['agencyID'] ?>"><?php echo $rowedit['agencyID'] ?>
                            <?php echo $rowedit4['agencyNama'] ?>
                            <div>
